import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, Suspense, Fragment, mergeProps, useSSRContext, defineAsyncComponent, onErrorCaptured, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "C:/Users/crist/Desktop/Forge/web/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/crist/Desktop/Forge/web/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/crist/Desktop/Forge/web/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/Users/crist/Desktop/Forge/web/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu } from "C:/Users/crist/Desktop/Forge/web/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "C:/Users/crist/Desktop/Forge/web/node_modules/ufo/dist/index.mjs";
import { debounce } from "C:/Users/crist/Desktop/Forge/web/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "C:/Users/crist/Desktop/Forge/web/node_modules/ohash/dist/index.mjs";
...
import { useSeoMeta as useSeoMeta$1, useHead as useHead$1, headSymbol } from "C:/Users/crist/Desktop/Forge/web/node_modules/@unhead/vue/dist/index.mjs";
if (!globalThis.$fetch) {
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-Bt1ltBhP.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CL8yOXt1.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-xEoqRjNr.js"));
