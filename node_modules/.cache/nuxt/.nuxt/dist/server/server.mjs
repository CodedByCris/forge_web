...
const _routes = [
  ...
  },
  {
    ...
    component: () => import("./_nuxt/index-CQZ3loif.js")
  },
  {
    name: "train",
    path: "/train",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "auth" } },
    component: () => import("./_nuxt/index-BiR3d1ca.js")
  },
  {
    name: "index",
    path: "/",
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-DGJRkwMu.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B9MQUzQL.js"));
